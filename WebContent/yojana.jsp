...
<div id="tooplate_main" class="center">
	<div class="content_wrapper content_mb_60">
        <div class="col_1">
            <center><h3>Application for Yojana Scheme</h3></center>
                <form method="post" name="contact" action="yojana1.jsp" >
             	<table align="center">
             		<tr>
             			<td>Name</td>
					...
					<tr>
             		...
             		<tr>
             			<td>Trainee Centre Name </td>
             			<td><input type="text" name="cname" required></td>
             		</tr>
             		<tr>
             			<td>Trainee Centre Address </td>
             			<td><textarea clos="10" rows="5" name="caddress" required></textarea></td>
             		</tr>
             		<tr>
