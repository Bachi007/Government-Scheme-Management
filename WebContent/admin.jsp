	...
	<div id="tooplate_header" class="center">
		...
		<div id="tooplate_menu" class="ddsmoothmenu">
            <ul>
                ...
                <li><a href="customer.jsp"><span></span>Customer</a></li>
                <li><a href="admin.jsp" class="selected"><span></span>Admin</a></li>                
            </ul>
            <br style="clear: left" />
...
<div id="tooplate_main" class="center">
	<div class="content_wrapper content_mb_60">
        <div class="col_1">
            <h1>Admin login</h1>
            <form method="post" name="contact" action="admin1.jsp" >
             	<table align="center">
             		<tr>
             			<td>Name</td>
              ...
              <br>
             <h3 align="center"><a href="reg.jsp">Registration</a></h3>
