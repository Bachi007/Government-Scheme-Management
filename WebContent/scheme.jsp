...
try
{
	...
	PreparedStatement ps=con.prepareStatement("select * from aarogyasri where status='"+status+"'");
	ResultSet rs=ps.executeQuery();
	PreparedStatement ps1=con.prepareStatement("select * from yojana where status='"+status+"'");
	ResultSet rs1=ps1.executeQuery();
	PreparedStatement ps2=con.prepareStatement("select * from awas where status='"+status+"'");
	ResultSet rs2=ps2.executeQuery();
	PreparedStatement ps3=con.prepareStatement("select * from jjby where status='"+status+"'");
...
<div id="tooplate_header_wrapper">
	<div id="tooplate_header" class="center">
		...
		<div id="tooplate_menu" class="ddsmoothmenu">
            <ul>
                <li><a href="ahome.jsp"><span></span>Home</a></li>
                <li><a href="scheme.jsp" class="selected"><span></span>View applicants</a></li>
                <li><a href="va.jsp"><span></span>View applicants status</a></li>
	...
	<div class="content_wrapper content_mb_60">
        <div class="col_1">
            	...
            	<%while(rs.next())
			{
			 ...
			 <td align="center"><font color="green"><a href="accept.jsp?id=<%=rs.getString(1)%>">Accept</a>/
			 <a href="reject.jsp?id=<%=rs.getString(1)%>">Reject</a>
			 </font></td>
			 </tr>
			 <%}%>
            	...
            	<%while(rs1.next())
			{
			 ...
			 <td align="center"><font color="green"><a href="accept1.jsp?id=<%=rs1.getString(1)%>">Accept</a>/
			 <a href="reject1.jsp?id=<%=rs1.getString(1)%>">Reject</a>
			 </tr>
			 <%}%>
            	...
            	<%while(rs2.next())
			{
			 ...
			 <td align="center"><font color="green"><a href="accept2.jsp?id=<%=rs2.getString(1)%>">Accept</a>/
			 <a href="reject2.jsp?id=<%=rs2.getString(1)%>">Reject</a>
			 </tr>
			 <%}%>
            	...
            	<%while(rs3.next())
			{
			 ...
			 <td align="center"><font color="green"><a href="accept3.jsp?id=<%=rs3.getString(1)%>">Accept</a>/
			 <a href="reject3.jsp?id=<%=rs3.getString(1)%>">Reject</a>
			 </tr>
			 <%}%>
